...
Remove-Module PSAADApplication -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSAADApplication\PSAADApplication.psd1"
Import-Module "$PSScriptRoot\..\PSAADApplication\PSAADApplication.psm1" -Force
